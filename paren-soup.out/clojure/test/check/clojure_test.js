...
clojure.test.check.clojure_test.assert_check = (function clojure$test$check$clojure_test$assert_check(p__15972){
...
var begin_test_var_method_15977 = cljs.core.get_method.call(null,cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"begin-test-var","begin-test-var",-908571100)], null));
cljs.core._add_method.call(null,cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"begin-test","begin-test",1831272774)], null),((function (begin_test_var_method_15977){
return (function (m){
...
if(cljs.core.truth_(begin_test_var_method_15977)){
return begin_test_var_method_15977.call(null,m);
} else {
return null;
}
});})(begin_test_var_method_15977))
);
clojure.test.check.clojure_test.get_property_name = (function clojure$test$check$clojure_test$get_property_name(p__15978){
...
var report_map = map__15979__$1;
var property_fun = cljs.core.get.call(null,map__15979__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","property","clojure.test.check.clojure-test/property",1356517781));
var or__7285__auto__ = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,property_fun));
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__15981){
...
var vec__15983 = cljs.core.get.call(null,map__15982__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","trial","clojure.test.check.clojure-test/trial",866433060));
var so_far = cljs.core.nth.call(null,vec__15983,(0),null);
var total = cljs.core.nth.call(null,vec__15983,(1),null);
if((so_far > (0))){
...
var temp__4657__auto__ = (function (){var and__7273__auto__ = clojure.test.check.clojure_test._STAR_report_trials_STAR_;
...
var trial_report_fn = temp__4657__auto__;
