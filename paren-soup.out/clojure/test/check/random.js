...
var x__7954__auto__ = (((rng == null))?null:rng);
var m__7955__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__7954__auto__)]);
if(!((m__7955__auto__ == null))){
return m__7955__auto__.call(null,rng);
} else {
var m__7955__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__7955__auto____$1 == null))){
return m__7955__auto____$1.call(null,rng);
} else {
...
var x__7954__auto__ = (((rng == null))?null:rng);
var m__7955__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__7954__auto__)]);
if(!((m__7955__auto__ == null))){
return m__7955__auto__.call(null,rng);
} else {
var m__7955__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__7955__auto____$1 == null))){
return m__7955__auto____$1.call(null,rng);
} else {
...
var x__7954__auto__ = (((rng == null))?null:rng);
var m__7955__auto__ = (clojure.test.check.random.split[goog.typeOf(x__7954__auto__)]);
if(!((m__7955__auto__ == null))){
return m__7955__auto__.call(null,rng);
} else {
var m__7955__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__7955__auto____$1 == null))){
return m__7955__auto____$1.call(null,rng);
} else {
...
var x__7954__auto__ = (((rng == null))?null:rng);
var m__7955__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__7954__auto__)]);
if(!((m__7955__auto__ == null))){
return m__7955__auto__.call(null,rng,n);
} else {
var m__7955__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__7955__auto____$1 == null))){
return m__7955__auto____$1.call(null,rng,n);
} else {
...
return clojure.test.check.random.longs.bit_xor.call(null,G__14358,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__14358;
}
});
...
var G__14361 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__14362 = cljs.core.conj_BANG_.call(null,ret,new_rng);
state__$1 = G__14361;
ret = G__14362;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__7896__auto__,writer__7897__auto__,opt__7898__auto__){
return cljs.core._write.call(null,writer__7897__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__7285__auto__ = clojure.test.check.random.longs.__GT_long.call(null,seed);
...
var state = cljs.core.get.call(null,map__14364__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__14366 = clojure.test.check.random.split.call(null,state);
var r1 = cljs.core.nth.call(null,vec__14366,(0),null);
var r2 = cljs.core.nth.call(null,vec__14366,(1),null);
