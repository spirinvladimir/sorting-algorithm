...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__13427,opts){
...
var files = cljs.core.get.call(null,map__13428__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__8410__auto___13436 = arguments.length;
var i__8411__auto___13437 = (0);
while(true){
if((i__8411__auto___13437 < len__8410__auto___13436)){
args__8417__auto__.push((arguments[i__8411__auto___13437]));

var G__13438 = (i__8411__auto___13437 + (1));
i__8411__auto___13437 = G__13438;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__13432){
var vec__13433 = p__13432;
var opts = cljs.core.nth.call(null,vec__13433,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__13433,opts){
return (function (evt){
...
});})(conn,vec__13433,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__13433,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__13433,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__13433,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq13430){
var G__13431 = cljs.core.first.call(null,seq13430);
var seq13430__$1 = cljs.core.next.call(null,seq13430);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__13431,seq13430__$1);
});
