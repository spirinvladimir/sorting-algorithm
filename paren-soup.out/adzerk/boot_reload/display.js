...
return (function (p__13260){
var vec__13261 = p__13260;
var attr = cljs.core.nth.call(null,vec__13261,(0),null);
var v = cljs.core.nth.call(null,vec__13261,(1),null);
...
var len__8410__auto___13268 = arguments.length;
var i__8411__auto___13269 = (0);
while(true){
if((i__8411__auto___13269 < len__8410__auto___13268)){
args__8417__auto__.push((arguments[i__8411__auto___13269]));

var G__13270 = (i__8411__auto___13269 + (1));
i__8411__auto___13269 = G__13270;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq13267){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq13267));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__13271){
...
var G__13274 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__13274,goog.events.EventType.CLICK,((function (G__13274,map__13272,map__13272__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__13274,map__13272,map__13272__$1,data,message,line,file))
);

return G__13274;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__13275){
...
var data = map__13276__$1;
var message = cljs.core.get.call(null,map__13276__$1,new cljs.core.Keyword(null,"message","message",-406056002));
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__13279){
...
var messages = map__13280__$1;
var warnings = cljs.core.get.call(null,map__13280__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__13280__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__13282 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__13282,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__13282,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__13283){
...
var messages = map__13284__$1;
var warnings = cljs.core.get.call(null,map__13284__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__13284__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__13284,map__13284__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__13284,map__13284__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__13284,map__13284__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__13284,map__13284__$1,messages,warnings,exception))
;
...
}catch (e13286){if((e13286 instanceof Error)){
var __13287 = e13286;
} else {
throw e13286;
