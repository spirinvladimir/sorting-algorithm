...
var G__15909 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__15909,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__15909;
}
});
...
var or__7285__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__8410__auto___15914 = arguments.length;
var i__8411__auto___15915 = (0);
while(true){
if((i__8411__auto___15915 < len__8410__auto___15914)){
args__8417__auto__.push((arguments[i__8411__auto___15915]));

var G__15916 = (i__8411__auto___15915 + (1));
i__8411__auto___15915 = G__15916;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8418__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq15911){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__15912,G__15913,seq15911__$2);
});
...
var file = cljs.core.get.call(null,map__15918__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15918__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15918__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__15918,map__15918__$1,file,line,column){
return (function (p1__15917_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__15917_SHARP_));
});})(map__15918,map__15918__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__8219__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__8219__auto__,prefer_table__8220__auto__,method_cache__8221__auto__,cached_hierarchy__8222__auto__,hierarchy__8223__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__7285__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__7285__auto__)){
return or__7285__auto__;
} else {
...
var temp__4657__auto___15920 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___15920)){
var message_15921 = temp__4657__auto___15920;
cljs.core.println.call(null,message_15921);
} else {
}
...
var temp__4657__auto___15922 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___15922)){
var message_15923 = temp__4657__auto___15922;
...
var temp__4655__auto__ = (function (){var and__7273__auto__ = typeof exception.stack === 'string';
if(and__7273__auto__){
var G__15925 = exception.stack;
var G__15925__$1 = (((G__15925 == null))?null:clojure.string.split_lines.call(null,G__15925));
var G__15925__$2 = (((G__15925__$1 == null))?null:cljs.core.get.call(null,G__15925__$1,depth));
if((G__15925__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__15925__$2);
}
} else {
...
var vec__15926 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__15926,(0),null);
var column = cljs.core.nth.call(null,vec__15926,(1),null);
var vec__15929 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__15929,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__15929,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__15929,(2),null);
...
var m__$1 = (function (){var G__15932 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__15932__$1 = (((G__15932 instanceof cljs.core.Keyword))?G__15932.fqn:null);
switch (G__15932__$1) {
case "fail":
...
var G__15936 = (function (){var G__15935 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__15935);
} else {
return G__15935;
}
})();
...
return cljs.core.vary_meta.call(null,G__15937,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__15941 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__15941,(0),null);
var types = vec__15941;
...
return cljs.core.map.call(null,(function (p__15944){
var vec__15945 = p__15944;
var ns = cljs.core.nth.call(null,vec__15945,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__15945,(1),null);
return ((function (vec__15945,ns,vars__$1){
return (function (){
...
var G__15948 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__15948,G__15948__$1,env,once_fixtures,each_fixtures,vec__15945,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__15948,G__15948__$1,env,once_fixtures,each_fixtures,vec__15945,ns,vars__$1){
return (function (){
var seq__15949 = cljs.core.seq.call(null,vars__$1);
var chunk__15950 = null;
var count__15951 = (0);
var i__15952 = (0);
while(true){
if((i__15952 < count__15951)){
var v = cljs.core._nth.call(null,chunk__15950,i__15952);
var temp__4657__auto___15954 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___15954)){
var t_15955 = temp__4657__auto___15954;
each_fixture_fn.call(null,((function (seq__15949,chunk__15950,count__15951,i__15952,t_15955,temp__4657__auto___15954,v,each_fixture_fn,G__15948,G__15948__$1,env,once_fixtures,each_fixtures,vec__15945,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_15955)));
});})(seq__15949,chunk__15950,count__15951,i__15952,t_15955,temp__4657__auto___15954,v,each_fixture_fn,G__15948,G__15948__$1,env,once_fixtures,each_fixtures,vec__15945,ns,vars__$1))
);
} else {
}

var G__15956 = seq__15949;
var G__15957 = chunk__15950;
var G__15958 = count__15951;
var G__15959 = (i__15952 + (1));
seq__15949 = G__15956;
chunk__15950 = G__15957;
count__15951 = G__15958;
i__15952 = G__15959;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__15949);
if(temp__4657__auto__){
var seq__15949__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__15949__$1)){
var c__8105__auto__ = cljs.core.chunk_first.call(null,seq__15949__$1);
var G__15960 = cljs.core.chunk_rest.call(null,seq__15949__$1);
var G__15961 = c__8105__auto__;
var G__15962 = cljs.core.count.call(null,c__8105__auto__);
var G__15963 = (0);
seq__15949 = G__15960;
chunk__15950 = G__15961;
count__15951 = G__15962;
i__15952 = G__15963;
continue;
} else {
var v = cljs.core.first.call(null,seq__15949__$1);
var temp__4657__auto___15964__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___15964__$1)){
var t_15965 = temp__4657__auto___15964__$1;
each_fixture_fn.call(null,((function (seq__15949,chunk__15950,count__15951,i__15952,t_15965,temp__4657__auto___15964__$1,v,seq__15949__$1,temp__4657__auto__,each_fixture_fn,G__15948,G__15948__$1,env,once_fixtures,each_fixtures,vec__15945,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_15965)));
});})(seq__15949,chunk__15950,count__15951,i__15952,t_15965,temp__4657__auto___15964__$1,v,seq__15949__$1,temp__4657__auto__,each_fixture_fn,G__15948,G__15948__$1,env,once_fixtures,each_fixtures,vec__15945,ns,vars__$1))
);
} else {
}

var G__15966 = cljs.core.next.call(null,seq__15949__$1);
var G__15967 = null;
var G__15968 = (0);
var G__15969 = (0);
seq__15949 = G__15966;
chunk__15950 = G__15967;
count__15951 = G__15968;
i__15952 = G__15969;
continue;
}
} else {
...
});})(each_fixture_fn,G__15948,G__15948__$1,env,once_fixtures,each_fixtures,vec__15945,ns,vars__$1))
);
});})(each_fixture_fn,G__15948,G__15948__$1,env,once_fixtures,each_fixtures,vec__15945,ns,vars__$1))
], null);
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15948__$1)].join('')));

}
})());
});
;})(vec__15945,ns,vars__$1))
